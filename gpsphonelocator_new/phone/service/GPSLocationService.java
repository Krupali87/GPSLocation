...
public class GPSLocationService extends Service {
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        if (intent != null && intent.getBooleanExtra("stop_service", false)) {
            ...
            Notification build = new NotificationCompat.Builder(context, String.valueOf(1)).setContentTitle(getString(R.string.locationService_ContentTitle)).setContentText(getString(R.string.locationService_ContentText)).setSmallIcon((int) R.drawable.logo).setContentIntent(pendingIntent).build();
...
//    }
    ...
    private final void showNotificationZone(boolean z, String str, String str2) {
        ...
        if (AppExtensionKt.getPref(baseContext, Constants.NOTIFICATION_ZONE_ALERT, true)) {
            ...
            NotificationCompat.Builder contentIntent = new NotificationCompat.Builder(context, "channel_name").setSmallIcon((int) R.drawable.logo).setContentTitle(str2 + " Zone").setContentText(charSequence).setAutoCancel(true).setContent(remoteViews).setStyle(new NotificationCompat.BigTextStyle()).setSound(RingtoneManager.getDefaultUri(2)).setContentIntent(pendingIntent);
    ...
    public final void showNotificationSOS(String str, String str2) {
        ...
        if (AppExtensionKt.getPref(baseContext, Constants.NOTIFICATION_SOS_ALERT, true)) {
            ...
            NotificationCompat.Builder contentIntent = new NotificationCompat.Builder(context, "channel_name").setSmallIcon((int) R.drawable.logo).setContentTitle("SOS Friends").setContentText(charSequence).setAutoCancel(true).setContent(remoteViews).setStyle(new NotificationCompat.BigTextStyle()).setSound(RingtoneManager.getDefaultUri(2)).setContentIntent(pendingIntent);
            Intrinsics.checkNotNullExpressionValue(contentIntent, "Builder(this, CHANNEL_ID…tentIntent(pendingIntent)");
            Object systemService = getSystemService("notification");
            Intrinsics.checkNotNull(systemService, "null cannot be cast to non-null type android.app.NotificationManager");
            NotificationManager notificationManager = (NotificationManager) systemService;
