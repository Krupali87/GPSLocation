        ...
        activityCreateZoneAlertBinding.etNameZone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (alertZone != null && isUpdate) {
                    EditText editText = inflate.dialogNameZone;
                ...
                if (z) {
                    inflate.dialogNameZone.setText(activityCreateZoneAlertBinding.etNameZone.getText().toString());
                }
                ...
                inflate.cvSend.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        if (!isFinishing()) {
                            ...
                            activityCreateZoneAlertBinding.etNameZone.setText(inflate.dialogNameZone.getText().toString());
                            ExtensionKt.hideKeyboard(CreateZoneActivity.this);
                            alertDialog.dismiss();
                            Window window = getWindow();
                            Intrinsics.checkNotNull(window);
