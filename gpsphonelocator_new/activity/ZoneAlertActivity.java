...
import com.app.gpsphonelocator_new.phone.util.SpacingItemDecoration;
...
public final class ZoneAlertActivity extends BaseActivity<ActivityZoneAlertBinding> {
    ...
    private final void initAdapter() {
        ...
        SpacingItemDecoration itemDecoration = new SpacingItemDecoration(20);
        ((ActivityZoneAlertBinding) getMBinding()).rvZone.addItemDecoration(itemDecoration);
